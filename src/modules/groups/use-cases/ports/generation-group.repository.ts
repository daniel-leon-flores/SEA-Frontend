...
export interface GenerationGroupRepository {
  getGenerationGroups(idGeneration: number, groupLetter?: string, status?: boolean, page?: number, pageSize?: number): Promise<ApiResponse<PaginatedData<GenerationGroup>>>;
